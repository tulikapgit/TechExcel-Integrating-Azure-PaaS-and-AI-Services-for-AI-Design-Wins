...
[KernelFunction]
    ...
    /// </summary>
[KernelFunction]
    [Description("Get bookings for a hotel by date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId,[Description("The datetime of the hotel booking")] DateTime dt)
    {
